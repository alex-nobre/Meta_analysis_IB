...
# Check if computation matches the reported value
# c9_cohensd <- c9_tvalue/sqrt(c9_n)
...
# Check if computation matches the reported value
# c10_cohensd <- c10_tvalue/sqrt(c10_n)
...
# Check if computation matches the reported value
# c11_cohensd <- c11_tvalue/sqrt(c11_n)
...
c72_cohensd <- (2 * c72_r)/sqrt(1 - (c72_r)**2)
...
c73_cohensd <- (2 * c73_r)/sqrt(1 - (c73_r)**2)
...
c74_cohensd <- (2 * c74_r)/sqrt(1 - (c74_r)**2)
...
c75_cohensd <- (2 * c75_r)/sqrt(1 - (c75_r)**2)
...
c76_cohensd <- c76_tvalue/sqrt(c76_n) 
...
c77_cohensd <- c77_tvalue/sqrt(c77_n) 
...
c78_n <- 69
c78_cohensd <- 0.123
c78_r <- sqrt((c78_cohensd**2)/(c78_cohensd**2 + 4))
...
# c79_n <- 86
# c79_cohensd <- 0.509
# c79_r <- sqrt((c79_cohensd**2)/(c79_cohensd**2 + 4))
...
c80_n <- 62
c80_cohensd <- 0.172
c80_r <- sqrt((c80_cohensd**2)/(c80_cohensd**2 + 4))
...
c81_n <- 64
c81_cohensd <- 0.037
c81_r <- sqrt((c81_cohensd**2)/(c81_cohensd**2 + 4))
...
c82_n <- 38
c82_cohensd <- 0.102
c82_r <- sqrt((c82_cohensd**2)/(c82_cohensd**2 + 4))
...
c83_n <- 290
c83_cohensd <- 0.115
c83_r <- sqrt((c83_cohensd**2)/(c83_cohensd**2 + 4))
...
c84_n <- 42
c84_cohensd <- 0.358
c84_r <- sqrt((c84_cohensd**2)/(c84_cohensd**2 + 4))
...
c85_n <- 33
c85_cohensd <- 0.410
c85_r <- sqrt((c85_cohensd**2)/(c85_cohensd**2 + 4))
...
c86_n <- 21
c86_cohensd <- 0.398
c86_r <- sqrt((c86_cohensd**2)/(c86_cohensd**2 + 4))
...
c87_n <- 34
c87_cohensd <- -0.050
c87_r <- sqrt((c87_cohensd**2)/(c87_cohensd**2 + 4)) * (-1) # Negative sign because effect is in the opposite direction of the hypothesis (i.e., below chance, as in p. 1058 of the paper)
...
c88_n <- 57
c88_cohensd <- 0.008
c88_r <- sqrt((c88_cohensd**2)/(c88_cohensd**2 + 4))
...
c89_n <- 64
c89_cohensd <- 0.035
c89_r <- sqrt((c89_cohensd**2)/(c89_cohensd**2 + 4))
...
c90_n <- 68
c90_cohensd <- 0.040
c90_r <- sqrt((c90_cohensd**2)/(c90_cohensd**2 + 4)) 
...
c91_n <- 178
c91_cohensd <- -0.009
c91_r <- sqrt((c91_cohensd**2)/(c91_cohensd**2 + 4)) * (-1) # Negative sign because effect is in the opposite direction of the hypothesis (i.e., below chance, as in p. 1058 of the paper)
...
c92_n <- 86
c92_cohensd <- 0.483
c92_r <- sqrt((c92_cohensd**2)/(c92_cohensd**2 + 4))
...
c93_n <- 86
c93_cohensd <- 0.531
c93_r <- sqrt((c93_cohensd**2)/(c93_cohensd**2 + 4))
